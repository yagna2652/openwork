...
export default {
  ...
  "chrome_setup.badge": "Chrome Connection",
  "chrome_setup.close": "Close",
  "chrome_setup.connected_message": "Chrome is connected. OpenWork can now control your browser, including your tabs, cookies, and sign-ins.",
  "chrome_setup.docs_link": "Chrome remote debugging docs",
  "chrome_setup.done": "Done",
  "chrome_setup.info_what_this_enables": "When connected, OpenWork can navigate tabs, fill forms, and read pages in your real Chrome — including sites where you're signed in. You can disconnect at any time by disabling remote debugging in Chrome.",
  "chrome_setup.status_checking": "Checking connection...",
  "chrome_setup.status_connected": "Chrome connected",
  "chrome_setup.status_unavailable": "Chrome not reachable — follow the steps below",
  "chrome_setup.status_unknown": "Not checked yet",
  "chrome_setup.step_one_allow": "Allow incoming debugging connections when Chrome asks.",
  "chrome_setup.step_one_enable": "Enable remote debugging.",
  "chrome_setup.step_one_hint": "Chrome 144+ lets you enable this without restarting. Your existing tabs, cookies, and sign-ins stay intact.",
  "chrome_setup.step_one_open_inspect": "In Chrome, go to",
  "chrome_setup.step_one_title": "Turn on Chrome remote debugging",
  "chrome_setup.step_two_hint": "After enabling remote debugging, click the button below to verify OpenWork can reach Chrome.",
  "chrome_setup.step_two_title": "Test the connection",
  "chrome_setup.subtitle": "Let OpenWork control your real Chrome browser — your tabs, cookies, and sign-ins — so it can work with sites where you're already logged in.",
  "chrome_setup.test_connection": "Test connection",
  "chrome_setup.title": "Connect your Chrome",
